var Game = Backbone.View.extend({
  ...
  inPressed: function(key){
    return _(this.pressed).any(function(code){return code === key});
  },
  ...
  getNamefromKeyCode: function(code){
    return _(this.keyNames).find(function(value, key){return parseInt(key) === code});
  },
  isKeyDir: function(code){
    return _([37, 39]).any(function(key){return key === code});
  },
